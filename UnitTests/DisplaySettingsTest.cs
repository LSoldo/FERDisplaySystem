...
//            var times = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 7, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.AddHours(-1), ds.DurationSpan.Add(TimeSpan.FromHours(4)), null, 1, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.AddHours(-1), TimeSpan.FromHours(1), null, 1, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.AddHours(-1), TimeSpan.FromHours(2), null, 1, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.AddHours(5), TimeSpan.FromHours(2), null, 1, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.AddHours(2), TimeSpan.FromHours(2), null, 1, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.AddHours(-1), TimeSpan.FromHours(5), null, 1, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime, TimeSpan.FromHours(2), null, 1, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, null, 1, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.AddHours(0.5), TimeSpan.FromHours(0.5), null, 1, sign, "Event");
...
//            var times = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, TimeSpan.FromHours(24), null, sign, "Event");
...
//            var times1 = manager.CreateDisplayTime(terminal, ds.StartTime, ds.DurationSpan, TimeSpan.FromHours(2), null, sign, "Event");
//            var times2 = manager.CreateDisplayTime(terminal, ds.StartTime.Add(TimeSpan.FromHours(2)), ds.DurationSpan, TimeSpan.FromHours(2), null, sign, "Event");
